...
const NAV_LINKS = ["Tranches", "Net Worth", "Connectors", "Markets"];
  ...
  return (
    ...
    >
      ...
      <div className="hidden gap-2 md:flex">
        ...
        <button
          onClick={handleSignIn}
          className="rounded-full bg-emerald-900 px-5 py-2.5 text-sm font-medium text-white shadow-sm transition hover:bg-emerald-800 focus:outline-none focus:ring-2 focus:ring-emerald-700 focus:ring-offset-2"
        >
          Sign Up
        </button>
      </div>
